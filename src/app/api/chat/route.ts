...
function profileToSystemPrompt(
  ...
  return [
    ...
    "- run_sql: SQL SELECT/WITH sobre la tabla `data` (agregaciones exactas; máx 50 filas de resultado)",
    "No inventes números ni filas que no vengan del profile o de las tools.",
    "Para totales, promedios, top-N o filtros sobre todo el dataset, preferí run_sql.",
    "",
